...
if (isset($_POST['option']) || isset($_POST['response'])) {
    ...
    switch ($option) {
        case 'delete':
            handleDeleteAction($postValues, $object, $bd, $response, $option);
            break;
        case 'update':
            handleUpdateAction($actionUser, $object, $option);
            break;
        case 'insert':
            handleInsertAction($actionUser, $option);
            break;
        case 'confirm':
            handleConfirmAction($postValues, $actionUser, $response, $object, $option, $bd);
            break;
    }
}
